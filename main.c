...
/* Active mode Scan time calculated in us ~= 1490us */
#define ACTIVE_MODE_FRAME_SCAN_TIME     (1490u)

/* Active mode Processing time in us ~= 52us with LEDs and Tuner disabled*/
#define ACTIVE_MODE_PROCESS_TIME        (52u)

/* ALR mode Scan time calculated in us ~= 1490us */
#define ALR_MODE_FRAME_SCAN_TIME        (1490u)

/* ALR mode Processing time in us ~= 52us with LEDs and Tuner disabled*/
#define ALR_MODE_PROCESS_TIME           (52u)
